...
* Fix incorrect datetime format in 1.LastRun Output.txt such as:
...
* Fix bug: tried to fix retroactive backup (see "incorrect datetime string.png") but this resulted in retroactive backups being placed in unknown location
* Logs exception to console when starting due to trying to save script.txt (via SaveOptions()) while the file is in use
